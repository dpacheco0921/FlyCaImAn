function batch_collectstacksperfly_b(FolderName, FileName, iparams)
% batch_collectstacksperfly_b: Second part towards compiling a whole fly brain
%   It reads metadata generated by batch_collectstacksperfly_a and applies
%   shifts to stacks to generate a whole fly stack
%   1) it prunes 3DxT volumes, using the mask generated in
%       batch_collectstacksperfly_a, basically getting rid of zero pixels after
%       aligning stacks
