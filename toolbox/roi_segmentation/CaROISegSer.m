...
%   p: structure generated by batch_CaROISegSer
%       (jobpart: step/type of segmentation to do:
%           jobpart = 1, run each patch and save intermediate results (1)
%           jobpart = 2, Compile intermediate results (2)
%           jobpart = 3, run each patch and save results directly
%               it does: (1), and saves all ROI segmentation 
%               parameters as in (2).
%           jobpart = 4, Compile intermediate results without 
...
display(['Files are saved at: ', target_dir])
