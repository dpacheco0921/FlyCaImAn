%% Parameters for 2D data at 10Hz
% default setting for
...
roiparams.se = strel(ones(6, 6));               % or even 1, try
...
roiparams.tau = [4 4];                          % std of gaussian kernel
roiparams.gSiz = [9 9];                         % size of gaussian kernel
roiparams.sr = 10;                              % sampling rate of data Hz
