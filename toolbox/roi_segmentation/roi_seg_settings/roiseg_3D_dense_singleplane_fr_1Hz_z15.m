...
roiparams.patch_size = [280, 280, 1];           % size of each patch along each dimension (optional, default: [32,32])
roiparams.overlap = [10, 10, 0];                % amount of overlap in each dimension (optional, default: [4,4])
...
roiparams.se = strel(ones(6, 6, 1));            % or even 1, try
...
roiparams.tau = [4 4 0];                        % std of gaussian kernel
roiparams.gSiz = [9 9 0];                       % size of gaussian kernel
roiparams.sr = 2;                               % sampling rate of data Hz
