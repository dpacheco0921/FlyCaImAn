...
roiparams.K = 800;                              % number of components to be found
                                                % for sparser labelling reduce this number (500)
roiparams.patch_size = [280, 280, 15];          % size of each patch along each dimension (optional, default: [32,32])
...
roiparams.se = strel(ones(6, 6, 7));            % or even 1, try
...
roiparams.tau = [4 4 3];                        % std of gaussian kernel
roiparams.gSiz = [9 9 7];                       % size of gaussian kernel
