function [A, b, C, f, S, P, RESULTS, YrA] = ...
    run_CNMF_patches_int_compile(...
    data, K, patches, tau, p, options, filename)
% run_CNMF_patches_int_compile: code similar to run_CNMF_patches
%   it runs CNMF for large datasets. this code compiles results from
%   several patches generated by run_CNMF_patches_int_runperseg
%
% Usage:
%   run_CNMF_patches_int_compile(...
%       data, K, patches, tau, p, options, filename)
...
while Km < Kn
    ...
    % update the cells that stores merged C,
    %   and their indexes to the C they generate
...
% remove small components (3-by-3 xy matrix)
%   it could even be harder (18 or 27, given that rois usually spans many planes
