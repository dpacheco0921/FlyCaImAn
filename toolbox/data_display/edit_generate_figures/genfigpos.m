function figpos = genfigpos(monitor_id, ...
    screen_position, figure_siz)
% genfigpos: function that provides with
%   positions for figures relative to current screen(s)
%
% Usage:
%   figpos = genfigpos(monitor_id, ...
%       screen_position, figure_siz)
%
% Args:
...
switch screen_position
    ...
    case 'nw'
        ...
        mon_center = mon_pos;
        mon_center(:, 2) = mon_center(:, 2) + ...
            mon_center(:, 4) - figure_siz(2);
        mon_center(:, 3) = figure_siz(1);
        mon_center(:, 4) = figure_siz(2);
